...
def plot_underdamped():
    ...
    smd.plot(t, [[k1[0] for k1 in y],[k1[1] for k1 in y]], r'State variables vs time ($m=1, c=2, k=4$; $f = cos(t)$)', \
    ...
    smd.plot(t, [[k1[0] for k1 in y],[k1[1] for k1 in y]], r'State variables vs time ($m=1, c=2, k=4$; $f = cos(4t)$)', \
    ...
    smd.plot(t, [[k1[0] for k1 in y],[k1[1] for k1 in y]], r'State variables vs time ($m=1, c=2, k=4$; $f = cos(2t)$)', \
